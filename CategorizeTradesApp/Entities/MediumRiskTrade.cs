...
{
    public class MediumRiskTrade(double value, string clientSector, DateTime nextPaymentDate) : ITrade
    {
        public double Value { get; } = value;
        public string ClientSector { get; } = clientSector;
        public DateTime NextPaymentDate { get; } = nextPaymentDate;
        public ETradeClassification TradeClassification => Enumerations.ETradeClassification.MEDIUMRISK;
    }
}
